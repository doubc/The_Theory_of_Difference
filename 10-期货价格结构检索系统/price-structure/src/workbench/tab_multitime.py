"""
Tab 6: 多时间维度 — 日线/1H/5M 编译 + 跨维度一致性 + K线对比 + 雷达图 + 研究建议
...
from src.data.sina_fetcher import fetch_bars as sina_fetch_bars
...
from src.workbench.shared import motion_badge, SENS_MAP
