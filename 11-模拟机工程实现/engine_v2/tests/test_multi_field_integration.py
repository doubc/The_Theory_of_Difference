"""
Test script for Multi-Field integration with environment_energy.py.

Verifies that OpenSystemCoupling correctly uses MultiFieldManager
to compute effective constraint at each step.
...
if __name__ == "__main__":
    print("=" * 60)
    print("Testing Multi-Field Integration")
    print("=" * 60)
