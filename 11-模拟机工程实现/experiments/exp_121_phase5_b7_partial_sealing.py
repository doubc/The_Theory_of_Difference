...
参数变更（v2）：
- binding_threshold: 0.05 → 0.02（线性缩放适应小 N L1 封口）
- 详见 docs/binding_threshold_tuning_for_small_n.md
...
def main():
    ...
    N0 = 48
    steps = 5000
    # Tuned for N=18 L1 sealing: linear scaling from N_ref=48, base=0.05
    # threshold = 0.05 * (18/48) = 0.01875 → rounded to 0.02
    # See docs/binding_threshold_tuning_for_small_n.md
